...
const unsigned short EXIF_TAG_DATE_TIME_DIGITIZED                       = 0x9004; /*!< @brief Exifタグ：ディジタルデータの作成日時 */
const unsigned short EXIF_TAG_OFFSET_TIME                               = 0x9010; /*!< @brief Exifタグ：DateTime の時差データ */
const unsigned short EXIF_TAG_OFFSET_TIME_ORIGINAL                      = 0x9011; /*!< @brief Exifタグ：DateTimeOriginal の時差データ */
const unsigned short EXIF_TAG_OFFSET_TIME_DIGITIZED                     = 0x9012; /*!< @brief Exifタグ：DateTimeDigitized の時差データ */
...
const unsigned short EXIF_TAG_COMPOSITE_IMAGE                           = 0xA460; /*!< @brief Exifタグ：合成画像 */
const unsigned short EXIF_TAG_SOURCE_IMAGE_NUMBER_OF_COMPOSITE_IMAGE    = 0xA461; /*!< @brief Exifタグ：合成画像のソース画像数 */
const unsigned short EXIF_TAG_SOURCE_EXPOSURE_TIMES_OF_COMPOSITE_IMAGE  = 0xA462; /*!< @brief Exifタグ：合成画像のソース画像露光時間 */
/*!
@}
...
@{
 */
const unsigned short EXIF_TAG_TEMPERATURE                               = 0x9400; /*!< @brief Exifタグ：温度 */
const unsigned short EXIF_TAG_HUMIDITY                                  = 0x9401; /*!< @brief Exifタグ：湿度 */
const unsigned short EXIF_TAG_PRESSURE                                  = 0x9402; /*!< @brief Exifタグ：圧力 */
const unsigned short EXIF_TAG_WATER_DEPTH                               = 0x9403; /*!< @brief Exifタグ：水深 */
const unsigned short EXIF_TAG_ACCELERATION                              = 0x9404; /*!< @brief Exifタグ：加速度 */
const unsigned short EXIF_TAG_CAMERA_ELEVATION_ANGLE                    = 0x9405; /*!< @brief Exifタグ：カメラの仰角 */
/*!
@}
...
@param entry サイズ取得用の Exif タグ構造体
*/
...
int getDateTimeOriginal(JpegBuffer *src, HashBuffer **retDateBin)
{
    ...
    {
        /*
         * 原画像データの生成日時を取得できなかった場合はエラー扱いにする。
         */
        ret = DATE_NOT_EXISTS;
        goto FINALIZE;
    }
